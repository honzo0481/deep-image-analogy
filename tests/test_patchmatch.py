...
def test_get_forward_patches_p(i, o, p, A, Bp, nnf):
...
def test_get_forward_patches_q0(i, o, q0, A, Bp, nnf):
    """_get_patches should return the correct subset of offsets from the nnf."""
    pm = Patchmatcher(A, Bp, NNF=nnf)
...
def test_get_forward_patches_q1(i, o, q1, A, Bp, nnf):
    """_get_patches should return the correct subset of offsets from the nnf."""
    pm = Patchmatcher(A, Bp, NNF=nnf)
...
def test_get_forward_patches_q2(i, o, q2, A, Bp, nnf):
    """_get_patches should return the correct subset of offsets from the nnf."""
    pm = Patchmatcher(A, Bp, NNF=nnf)
